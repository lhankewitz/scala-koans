...
class AboutImportsAndPackages extends KoanSuite with Matchers {
...
class AboutImportsAndPackagesInSubpackages extends KoanSuite with Matchers {
...
class AboutReferencingAbsolutePackages extends KoanSuite with Matchers {
...
class AboutReferencingAbsoluteRootPackages extends KoanSuite with Matchers {
...
class AboutReferencingRelativePackages extends KoanSuite with Matchers {
...
class AboutImportingTechniques extends KoanSuite with Matchers {
